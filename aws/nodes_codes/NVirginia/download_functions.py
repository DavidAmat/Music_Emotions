...
def comando_youtube(track_id, url, path_audio = 'data/'):
    ...
    comando2 = f" --output {path_output}  --rm-cache-dir"
...
def file_to_S3(local_path, S3_path,  S3_BUCKET = 'musicemotions'):
    ...
    """
    s3 = boto3.resource('s3',region_S3)
